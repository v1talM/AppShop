...
@section('content')
    ...
    <div class="row">
        <form id="goods_form" action="{{ route('goods.update',['id' => $goods->id]) }}" class="form" accept-charset="utf-8" method="post" enctype="multipart/form-data">
            <div class="x_panel">
                <div class="x_title">
                    <h2>商品信息</h2>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" class="form-control hidden"  name="category_id" value="{{ $goods->category_id }}">
                                    {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" class="form-control" value="{{ $goods->name }}" name="name" placeholder="请输入商品名称">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" class="form-control" name="click_count" value="{{ $goods->click_count }}" placeholder="请输入商品点击量">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" class="form-control" name="give_integral" value="{{ $goods->give_integral }}" placeholder="请输入赠送积分">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">简短描述</label>
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <textarea name="goods_brief" cols="30" rows="2" class="form-control">{{ $goods->goods_brief }}</textarea>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <div class="radio">
                                        <label>
                                            <input type="radio" value="1" {{ ($goods->is_new == 1)?'checked':'' }}  name="is_new">是
                                        </label>
                                        <label>
                                            <input type="radio" value="0" {{ ($goods->is_new == 0)?'checked':'' }}  name="is_new">否
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <div class="radio">
                                        <label>
                                            <input type="radio" value="1" {{ ($goods->is_delete == 0)?'checked':'' }}  name="is_delete">是
                                        </label>
                                        <label>
                                            <input type="radio" value="0" {{ ($goods->is_delete == 1)?'checked':'' }}  name="is_delete">否
                                        </label>
                                    </div>
                                </div>
                            </div>
